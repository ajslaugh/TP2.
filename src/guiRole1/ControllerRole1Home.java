...
import guiPostDisplay.ViewPostDisplay;
...
public class ControllerRole1Home {
	...
	protected static void viewPosts() {
		ViewPostDisplay.displayPosts(ViewRole1Home.theStage, ViewRole1Home.theUser);
	}
	...
	protected static void performLogout() {
		ViewUserLogin.displayUserLogin(ViewRole1Home.theStage);
	}
